...
<%-- SEARCH FILTER: pre-fills from URL parameter for convenience --%>
<%-- VULNERABILITY: XSS - param.search is rendered without escaping --%>
<c:if test="">
<script>document.write('<input id="appointmentSearch" type="text" value="" />');</script>
</c:if>
